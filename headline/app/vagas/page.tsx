    ...
    <div className=" overflow-x-hidden">
      ...
      <div className=" flex items-center justify-center">
        <div className=" text-white items-center justify-center flex flex-col">
          <h1 className="max-w-4xl text-2xl md:text-3xl text-focus-in text-center">Nós transformamos experts desconhecidos em verdadeiras celebridades - enquanto vendem milhões!</h1>
          <p className="md:text-xl text-lg mt-2 text-focus-in-demorado">Você pode ser o próximo…</p>
          <Button nameButton={"Bora escalar?"} link={"#"} />
        </div>
      </div>
