    ...
    <div className="">
      <div className="relative h-screen flex overflow-hidden">
        <div className="absolute w-full items-center justify-center flex flex-col text-center text-white z-20 inset-0 ">
          <h1 className="max-w-4xl text-xl md:text-3xl tracking-in-contract">Nós transformamos experts desconhecidos em verdadeiras celebridades - enquanto vendem milhões!</h1>
