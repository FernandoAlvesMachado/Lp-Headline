    ...
    return (
        <div className="h-screen z-40 w-full items-center justify-center flex">
            <div className="flex gap-12 h-[450px] max-w-6xl flex-col md:flex-row items-center justify-center relative" ref={containerRef}>
                <div className="max-w-2xl w-full h-96 bg-blue-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border border-gray-100 flex items-center justify-center p-4 text-white text-center glow-container">
                ...
                <div className='flex flex-col h-96 gap-5 w-52'>
                    <div className="max-w-2xl w-full h-full bg-blue-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border border-gray-100 flex items-center justify-center p-4 text-white text-center glow-container">
