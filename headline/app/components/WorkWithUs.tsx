                ...
                <div className="flex items-center p-6 justify-center gap-5 flex-col">
                    ...
                    <div className="flex gap-12 flex-wrap md:flex-nowrap  w-full ">
                        ...
                        <div className="w-full p-6  border border-gray-200 rounded-lg shadow bg-gray-800 border-gray-700">
                            ...
                            <a href="#" className="inline-flex my-3 px-3 py-2  items-center w-full text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
                                CLIQUE AQUI
